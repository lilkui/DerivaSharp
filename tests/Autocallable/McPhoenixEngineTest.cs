...
public sealed class McPhoenixEngineTest
{
    ...
    public McPhoenixEngineTest()
    {
        ...
        _obsDates = SseCalendar.Shared.GetMonthlyObservationDates(_effectiveDate, _expirationDate, 3).ToArray();
        ...
        _engine = new McPhoenixEngine(100000, s_useCuda, 42);
    }
