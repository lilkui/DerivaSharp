...
DerivaSharp is a C# library for pricing financial derivatives.
...
You can find usage examples in the `notebooks` folder. These examples demonstrate how to use the library in a Jupyter notebook with Python using [Python.NET](http://pythonnet.github.io/).
